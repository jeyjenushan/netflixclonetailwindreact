...
function Slider() {
  ...
  return (
    ...
    <HiChevronRight className="hidden md:block text-white text-[30px] right-0 absolute mx-8 mt-[150px] cursor-pointer"  onClick={()=>sliderRight(elementRef.current)}/>
    

    <div className='flex overflow-auto w-full px-16 py-4 scrollbar-hide scroll-smooth' ref={elementRef}>
